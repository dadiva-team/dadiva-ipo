        ...
        >
          ...
          <FormControl fullWidth>
            ...
            {subQuestions.length > 0 && (
              <FormHelperText>
                Não pode alterar o tipo de resposta enquanto existirem subquestões que dependem desta
              </FormHelperText>
            )}
          </FormControl>
              ...
              <List>
                {subQuestions.map(subQuestion => (
                  <ListItem key={subQuestion.id}>
                    ...
                    >
                      <IconButton aria-label="delete" onClick={() => onOpenSubQuestionDialog(subQuestion)}>
                        <OpenInNewIcon />
                      </IconButton>
                      <IconButton
                        aria-label="delete"
                        onClick={() => {
                          ...
                          setAlert(
                            `Esta questão será removida das condições que ativam essa subquestão. Guardar para confirmar.`
                          );
                        }}
                      >
                        <Delete />
            ...
            <>
              ...
              >
                <FormControl fullWidth margin="normal">
                  ...
                  >
                    {questions
                      ?.filter(q => q.id !== questionId && !q.showCondition)
                      .map(q => (
