    ...
    return (
        ...
        >
            ...
            >
                ...
                <Box>
                    <IconButton disabled={!props.onMoveUp} edge="end" aria-label="up"
                                onClick={() => props.onMoveUp()}>
                        <ArrowUpward/>
                    </IconButton>
                    <IconButton disabled={!props.onMoveDown} edge="end" aria-label="down"
                    ...
                    <IconButton disabled={!props.onDelete} edge="end" aria-label="delete"
