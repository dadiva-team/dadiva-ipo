...
export function NoteDialog({ open, note, onAnswer, onClose }: NoteDialogProps) {
  ...
  return (
    <Dialog onClose={onClose} open={open} aria-labelledby="edit-dialog-title" maxWidth="sm" fullWidth>
      ...
      <DialogContent dividers>
        ...
        >
          ...
          <Box display="flex" justifyContent="space-between" width="70%">
            ...
            <Button onClick={handleCloseAndAnswer} disabled={noteText.length === 0}>
              Guardar Nota
            </Button>
          </Box>
        </Box>
