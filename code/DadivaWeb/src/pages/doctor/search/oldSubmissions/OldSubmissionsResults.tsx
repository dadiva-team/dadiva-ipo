...
import {
    ...
    MenuItem,
    ToggleButton,
    ToggleButtonGroup, SelectChangeEvent, IconButton
} from "@mui/material";
...
export function OldSubmissionsResults(
    ...
    const filteredSubmissions = Array.from(submissions.keys()).filter(submission => {
        ...
        const yearMatches = yearFilter === 'all' || new Date(submission.submissionDate).getFullYear().toString() === yearFilter;
                ...
                <Box sx={{display: 'flex', alignItems: 'center', mb: 2}}>
                    ...
                    <FormControl variant="outlined" size="small" sx={{minWidth: 120, mr: 2}}>
                        ...
                        >
                            ...
                            {Array.from(new Set(Array.from(submissions.keys()).map(sub => new Date(sub.submissionDate).getFullYear().toString())))
                                .map(year => (
