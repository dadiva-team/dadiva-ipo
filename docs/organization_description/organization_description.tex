...
Run the "node populate-es.js" command in the \path{dadiva-ipo\code} directory to populate the ElasticSearch database.

Run the "dotnet run --launch-profile https" command in the \path{dadiva-ipo\code\DadivaAPI\DadivaAPI} directory.
