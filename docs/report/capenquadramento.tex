...
\begin{figure}[h]
	\begin{center}
		\resizebox{160mm}{!}{\includegraphics[trim={0 380 70 310},clip]{./figures/useCases.pdf}}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\resizebox{140mm}{!}{\includegraphics[trim={0 540 70 0},clip]{./figures/useCases.pdf}}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\resizebox{140mm}{!}{\includegraphics[trim={0 150 50 460},clip]{./figures/useCases.pdf}}
	\end{center}
