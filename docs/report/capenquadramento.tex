...
\begin{figure}[H]
	\begin{center}
		\resizebox{100mm}{!}{\includegraphics[trim={0 370 70 0},clip]{./figures/useCases.png}}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\resizebox{100mm}{!}{\includegraphics[trim={0 210 70 150},clip]{./figures/useCases.png}}
	\end{center}
...
\begin{figure}[H]
	\begin{center}
		\resizebox{100mm}{!}{\includegraphics[trim={0 0 0 300},clip]{./figures/useCases.png}}
	\end{center}
